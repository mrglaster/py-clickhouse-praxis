...
"""The proxy class for the clickhouse database connection"""
class db_proxy():
    __client = None
    __is_open = False
    __error_text = ""
    ...
    @property
    def is_error(self):
        """Returns the latest condition flag"""
        return not self.__error_text == "" 

    @property    
    def get_last_data(self):
        """Returns latest successfull selection data"""
        return self.__data
    

    def get_rows(self, sql, map_type):
        """ Executes the SQL-query and builds an array consisting of structures <map_type>. """
